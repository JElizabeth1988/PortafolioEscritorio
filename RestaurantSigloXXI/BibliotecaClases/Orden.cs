        ...
        public List<ListaOrden> FiltrarRut(string rut)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    i.mesa = int.Parse(reader[4].ToString());
                    i.Cantidad = reader[5].ToString() + " U.";
                    i.Rut_Cliente = reader[6].ToString();
                    i.Cliente = reader[7].ToString();
                    i.Estado = reader[8].ToString();
                    i.Plato = reader[9].ToString();
                    i.Bebida = reader[10].ToString();
                    i.Garzón = reader[11].ToString();
                    i.Valor = "$ " + reader[12].ToString();
        ...
        public List<ListaOrden2> ListarTablero()
        {
            try
            {
                ...
                while (dr.Read())
                {
                    ...
                    i.Estado = dr.GetValue(8).ToString();
                    i.Plato = dr.GetValue(9).ToString();
                    i.Receta = dr.GetValue(10).ToString();
                    i.tiempoPreparación = dr.GetValue(11).ToString() + " Minutos";
                    i.Bebida = dr.GetValue(12).ToString();
                    i.Garzón = dr.GetValue(13).ToString();
        ...
        public List<ListaOrden2> FiltrarRutTablero(string rut)
        {
            try
            {
                ...
                while (reader.Read())
                {
                    ...
                    i.Estado = reader[8].ToString();
                    i.Plato = reader[9].ToString();
                    i.Receta = reader[10].ToString();
                    i.tiempoPreparación = reader[11].ToString() + " Minutos";
                    i.Bebida = reader[12].ToString();
                    i.Garzón = reader[13].ToString();
